...
import pa2.parser.ComponentSelector;
import pa2.parser.DocumentParser;
...
private static final Point3D INITIAL_POSITION = new Point3D(0, 0, 0);
private static final String TOP_LEVEL_NAME = "top level";
private static final double ROTATION_ANGLE = 2.0;
...
public static void main(final String[] args) {
  ...
  private ComponentSelector cpSelector;
  private HashMap<String , ComponentNode> resource = new HashMap<>();
  ...
  public void initScene(){
	    ...
	    ComponentNode root = null;
	    DocumentParser p = null;
		try {
			p = new DocumentParser("structure.xml");
			root = p.buildTree(resource, glut);
	 ...
	 //   this.cpSelector = new ComponentSelector("control.txt", resource);

	    this.topLevelComponent.addChild(root.comp);
  }
  ...
  public void keyTyped(final KeyEvent key) {
    ...
    case 'z':
      ...
      break;
    default:
      for(ComponentNode n : this.cpSelector.select(String.valueOf(input))){
    	  toggleSelection(n);
